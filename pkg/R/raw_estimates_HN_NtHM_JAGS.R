raw_estimates_HN_NtHM_JAGS<-function (df, rlmc = 0.5, mu_mean = 0, mu_sd = 4,
                                      nchains=4, nadapt=4000, nburnin=20000,
                                      niter=120000, nthin=4,tdf=15){
  
  # Computation of posterior estimates of NtHM with a HN heterogeneity prior in JAGS
