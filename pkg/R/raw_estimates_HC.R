...
function(df, rlmc=0.5, mu_mean=0, mu_sd=4){
  ## raw estimates for Bayesian NNHM meta-analyses with a HC heterogeneity prior subject to a RLMC-based adjustment
  ...
  # tau.prior: (base prior parameter values) function containing the function with the density of the prior for tau
